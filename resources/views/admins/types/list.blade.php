                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="" title="Sửa" data-id="{{ $item->id }}"
                                                        ...
                                                        <form class="d-flex align-items-center"
                                                            ...
                                                            action="{{ route('delete.type', ['id' => $item->id]) }}">
                                                            @csrf
                                                            @method('DELETE')
            ...
            <form method="POST" action="{{ route('store.type') }}" class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        ...
                        <x-form.input2 class="col-12" :error="$errors->first('redirect_url')" name="redirect_url" label="Redirect Url"
                            type="text" />
                    </div>
                </div>
    ...
    <div class="modal fade" id="modal-2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('store.type') }}" id="form-edit" class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <x-form.input2 class="col-12" classChild="inp-name" :error="$errors->first('name')" name="name"
                            label="Name" type="text" />
                        <x-form.input2 class="col-12" classChild="inp-url" :error="$errors->first('redirect_url')" name="redirect_url"
                            label="Redirect Url" type="text" />
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
