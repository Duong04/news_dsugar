                ...
                <div class="col-12 col-xl-6 mt-4">
                    <a href="" class="h-sm-300 d-flex overflow-hidden position-relative rounded-4 h-600 shadow-img post-hv">
                        ...
                        <div class="ct-text text-white">
                            <span class="ct-topic fs-7 hover-fillip-item position-relative" data-text="Phong cách sống">Phong cách sống</span>
                    ...
                    <div class="h-600 d-grid-2">
                        <a href="" class="h-sm-300 d-flex overflow-hidden position-relative rounded-4 shadow-img post-hv">
                            ...
                            <div class="ct-text text-white" style="bottom: 15px">
                                <span class="ct-topic fs-7 position-relative hover-fillip-item" data-text="Phong cách sống">Phong cách sống</span>
                    ...
                    <div id="tab-1" class="mt-5 tab-pane fade show active">
                        <div class="d-flex flex-column flex-lg-row align-items-center g-20">
                            <div class="col-12 col-lg-5">
                               <a class="post-item border-bottom border-1 border-dark-subtle py-4 d-flex align-items-center g-10 text-decoration-none">
                                   <div class="post-img rounded-4">
                                       <img class="h-100 w-100 rounded-4 object-fit-cover" src="images/news/demo_image-21-300x300.jpg" alt="">
                                   </div>
                                   <div class="post-text">
                                       <span class="text-danger position-relative hover-fillip-item" data-text="Mobile">Mobile</span>
                                       <h5 class="post-title text-black fw-semibold">Oppo Find X2 Pro Review: Supercar Smartphone</h5>
                                   </div>
                               </a>
                               <a class="post-item border-bottom border-1 border-dark-subtle py-4 d-flex align-items-center g-10 text-decoration-none">
                                    <div class="post-img rounded-4">
                            ...
                            <div class="col-12 col-lg-7 p-lg-3">
                               <a href="" class="post-large-item d-flex justify-content-end position-relative">
                                   <div class="post-large-img rounded-4 my-lg-3 my-lg-0">
                                       <img class="w-100 h-100 object-fit-cover rounded-4" src="images/news/demo_image-20-705x660.jpg" alt="">
                                   </div>
            ...
            <div class="container-md d-flex flex-column flex-lg-row mx-auto">
                    ...
                    <div class="d-flex flex-column g-30 mt-4">
                        <div class="post-list-view d-flex flex-column flex-sm-row justify-content-between">
                            <div class="col-12 col-sm-4 post-list-img rounded-top-sm-4 rounded-4 overflow-hidden">
                                <img class="h-100 w-100 object-fit-cover" src="images/news/demo_image-36-300x169.jpg" alt="">
                            </div>
                            <div class="col-12 col-sm-8 p-0 ps-sm-3 post-list-text">
                                <div class="rounded-bottom-sm-4 rounded-4 border border-2 px-3 pt-5 px-md-4 pb-4 p-lg-5 d-flex flex-column g-10 justify-content-center">
                                    <span class="b-red position-relative hover-fillip-item" data-text="Food"></span>
                                    <a href="" class="text-black fw-semibold text-decoration-none fs-5 post-title">I saw few die of hunger; of eating, a hundred thousand.</a>
                ...
                <aside class="col-12 col-lg-4 mt-5 mt-lg-0">
                    <div class="p-0 ps-lg-5">
                        <div>
                            <h5 class="border-bottom border-dark-subtle text-center fw-semibold pb-2">Tìm kiếm</h5>
                            <form class="d-flex search-custom mt-3" role="search">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="d-flex flex-column g-20 mt-3">
                                <a href="" class="post-medium d-flex g-10 text-decoration-none">
                                    <div class="post-medium-img rounded-4 overflow-hidden">
                                        <img class="w-100 h-100 object-fit-cover rounded-4" src="images/news/gallery-post-03-150x150.jpg" alt="">
                                    </div>
                                    <div class="post-medium-text">
                                        <h6 class="text-black">4 types of research methods all designers</h6>
                                        <span class="text-midgray fs-7">January 24, 2021</span>
                                    </div>
                                </a>
                                <a href="" class="post-medium d-flex g-10 text-decoration-none">
                                    <div class="post-medium-img rounded-4 overflow-hidden">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="d-flex g-10 social-share justify-content-center mt-4">
